...
*  
*/
public class AWSSpotInstanceScalar extends SpotInstanceScalar{
	
	protected static Logger mainLog = LogManager.getLogger(AWSSpotInstanceScalar.class);
	...
	/**
	 * @Title: main 
	 * @Description: the main method for aws instance scalar
	 * @param args the file path to the configuration file folder
	 * @throws
	 */
	public static void main(String[] args) {
		AWSSpotInstanceScalar awsSpotInstanceScalar = new AWSSpotInstanceScalar();
		awsSpotInstanceScalar.start(args);
	}
