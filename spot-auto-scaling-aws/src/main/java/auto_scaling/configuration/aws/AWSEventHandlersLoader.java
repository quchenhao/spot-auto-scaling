...
/** 
* @ClassName: AWSEventHandlersLoader 
* @Description: loader to load event handlers for Amazon AWS
* @author Chenhao Qu
* @date 05/06/2015 2:14:32 pm 
*  
*/
public class AWSEventHandlersLoader implements IEventHandlersLoader{
	
	/** 
	* <p>Description: empty initialization</p>  
	*/
	public AWSEventHandlersLoader() {}
	...
	*/
	...
	public Map<String, EventHandler> load(
			ICloudConfiguration cloudConfiguration, ICapacityCalculator capacityCalculator, IScalingPoliciesConfiguration scalingPoliciesConfiguration,
			Map<String, Monitor> monitors, IOnlineTask onlineTask, InputStream inputSteram) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, IOException {
		...
		String instancesImpairedEventHandlerClass = properties.getProperty(EventHandlers.INSTANCES_IMPAIRED_EVENT_HANDLER);
		EventHandler instancesImpairedEventHandler = (EventHandler)(Class.forName(instancesImpairedEventHandlerClass).newInstance());
		
		eventHandlers.put(Events.INSTANCES_IMPAIRED_EVENT, instancesImpairedEventHandler);
		...
		ScalingEventHandler scalingEventHandler = (ScalingEventHandler)(Class.forName(scalingEventHandlerClass).newInstance());
		scalingEventHandler.setCloudConfiguration(cloudConfiguration);
